...
(function() {
  ...
  document.write('<script src="bower_components/danialfarid-angular-file-upload/dist/angular-file-upload-shim.min.js"></script>');

  document.write('<script src="bower_components/angular/angular.min.js"></script>');

  document.write('<script src="bower_components/danialfarid-angular-file-upload/dist/angular-file-upload.min.js"></script>');

  document.write('<script src="bower_components/angular-route/angular-route.min.js"></script>');

  document.write('<script src="bower_components/angular-cookies/angular-cookies.min.js"></script>');

  document.write('<script src="bower_components/angular-cache/dist/angular-cache.min.js"></script>');

  document.write('<script src="bower_components/iCheck/icheck.min.js"></script>');

  document.write('<script src="bower_components/angular-animate/angular-animate.min.js"></script>');

  document.write('<script src="bower_components/angular-bootstrap/ui-bootstrap-tpls.min.js"></script>');

  document.write('<script src="bower_components/lodash/dist/lodash.min.js"></script>');

  document.write('<script src="bower_components/restangular/dist/restangular.min.js"></script>');

  document.write('<script src="bower_components/momentjs/min/moment.min.js"></script>');

  document.write('<script src="bower_components/twix/bin/twix.min.js"></script>');

  document.write('<script src="bower_components/firebase/firebase.js"></script>');

  document.write('<script src="bower_components/angularfire/angularfire.js"></script>');
